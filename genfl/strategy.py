...
class FedAvgWithGenFL(fl.server.strategy.FedAvg):
    ...
    def aggregate_fit(self, server_round, results, failures):
        ...
        client2model = {fit_res.metrics["cid"]: self._to_pt_model(fit_res.parameters) for _, fit_res in results}
        ...
        res  = provenance_of_fl_clients(gmodel=global_model, c2model=client2model, test_data=self.test_data)  
