...
interact -N1 -n 1 -A semcache -p h200_normal_q --qos tc_h200_normal_short -t 18:00:00 --gres=gpu:1 --cpus-per-task=12 --ntasks-per-node=1
...
interact -N1 -n 1 -A semcache -p a100_normal_q --qos tc_a100_normal_short -t 8:00:00 --gres=gpu:1 --cpus-per-task=12 
